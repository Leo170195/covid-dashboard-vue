<template>
  <div id="app">
    <h1 class="text-center mt-5 text-bs">Covid Dashboard</h1>
    <img src="/../favicon.ico" class="d-flex mx-auto my-5">
    <div id="today" class="text-b text-center my-2">
    ...
    <div class="container mt-5 pt-5">
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <div id="single-region" class="col-12 col-lg-6 d-flex flex-wrap">
                        <h4 class="text-bs w-100 mb-4 text-center">Bollettino giornaliero</h4>
                        <div class="col-12 col-lg-6 p-2" v-for="dateRegion in dateRegionsToday" :key="dateRegion.codice_regione">
                            <div class="card-neo h-100" :id="dateRegion.denominazione_regione" @click="hoverCard(dateRegion.denominazione_regione)">
                                <div class="card-body">
                    ...
                    <div class="col-12 col-lg-6 p-4">
                        <label for="day" class="form-label">Giorno selezionato <strong> {{ dayPrint }}</strong> </label>
                        <input type="range" class="form-range" id="day" v-model="dayMax">
                        ...
                        <g id="map-of-italy" transform="translate(-2.000026,-112.0499)">
                            <path fill="#16b1b6" data-region="Valle d'Aosta" d="M63.759,213.32c-5.313,1.354-9.802,6.954-15.825,5.334
                            ...
                            <path fill="#16b1b6" data-region="Piemonte" d="M76.352,371.395c0.758,0.629,3.199,1.311,5.424,1.515
                            ...
                            <path fill="#16b1b6" data-region="Lombardia" d="M168.53,320.902c-0.449-2.394-0.13-3.692,1.317-5.361
                            ...
                            <path fill="#16b1b6" data-region="Emilia-Romagna" d="M341.22,402.06c1.391-3.22,2.529-7.678,2.601-10.194
                            ...
                            <path fill="#16b1b6" data-region="Liguria"
                            ...
                            <g id="g2992" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#16b1b6" data-region="Toscana"
                            ...
                            <path fill="#16b1b6" data-region="Marche"
                            ...
                            <path fill="#16b1b6" data-region="P.A. Bolzano" d="M360.006,148.629c-1.309-0.701-2.381-1.859-2.381-2.574c0-3.682-7.452-14.501-9.988-14.501
                            ...
                            L360.006,148.629z" />
                            <path fill="#16b1b6" data-region="P.A. Trento"
                            ...
                            <g transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#16b1b6" data-region="Veneto" d="M508.071,192.742c-1.375-2.85-2.5-5.908-2.5-6.794c0-1.254-0.778-1.521-3.5-1.203
                            ...
                            <g id="g2981" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#16b1b6" data-region="Friuli Venezia Giulia"
                            ...
                            <g id="g3019" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#16b1b6" data-region="Sicilia"
                            ...
                            <path fill="#16b1b6" data-region="Calabria" d="M586.708,876.267c1.126-1.667,2.343-5.261,2.705-7.987
                            ...
                            <g id="g3015" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#16b1b6" data-region="Campania"
                            ...
                            <path fill="#16b1b6" data-region="Lazio" d="M404.512,613.385c0.292-0.473,2.533-1.542,4.98-2.375
                            ...
                            <path fill="#16b1b6" data-region="Umbria" d="M370.865,518.534c0.538-1.005,0.742-2.444,0.453-3.197
                            ...
                            <path fill="#16b1b6" data-region="Abruzzo"
                            ...
                            <path fill="#16b1b6" data-region="Puglia" d="M727.704,724.486c0.519-6.754,1.72-9.814,5.216-13.289
                            ...
                            <path fill="#16b1b6" data-region="Molise" d="M500.916,600.968c1.555,0,3.057-0.811,3.926-2.121
                            ...
                            <path fill="#16b1b6" data-region="Basilicata"
                            ...
                            <g id="g3044" transform="matrix(0.948312,0,0,0.948312,-83.88148,51.95865)">
                                <path fill="#16b1b6" data-region="Sardegna"
...
export default {
  ...
  mounted() {
        ...
        .then(dati => {
            this.dati = dati;
            // console.log(dati.slice(dati.length - 21));

            this.dateRegionsToday = dati.slice(dati.length - 21)

            // console.log(dati.filter(d => d.data == "2020-02-24T18:00:00"));

            this.today = this.dateRegionsToday[0].data.split("T")[0].split('-').reverse().join('-')

            this.regionName = this.dateRegionsToday.map(d => d.denominazione_regione)
            
            this.totalCases = dati.map(d => d.nuovi_positivi).reduce((accumulator, currentValue) => accumulator + currentValue)

            this.totalDeath = this.dateRegionsToday.map(d => d.deceduti).reduce((accumulator, currentValue) => accumulator + currentValue)

            this.totalHealed = this.dateRegionsToday.map(d => d.dimessi_guariti).reduce((accumulator, currentValue) => accumulator + currentValue)

            this.positive = this.totalCases - this.totalDeath - this.totalHealed;
            ...
            console.log(this.dateRegionsToday);
            console.log(this.dateSelectedData);
    ...
    updated(){
        ...
        // console.log(this.dateSelectedData[0].data.split("T")[0].split('-').reverse().join('-'));
